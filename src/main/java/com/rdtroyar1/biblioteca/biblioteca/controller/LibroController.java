package com.rdtroyar1.biblioteca.biblioteca.controller;

import com.rdtroyar1.biblioteca.biblioteca.dto.LibroDTO;
import com.rdtroyar1.biblioteca.biblioteca.service.LibroService;
...
public class LibroController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<HttpStatus> deleteBy(@PathVariable Integer id){
        try {
